  ...
  return (
    <Box w="100%" h="100vh" position={"relative"} bg={bg} color={color}>
      <Box
        position={"absolute"}
        top={["24px", "24px", "30px"]}
        right={["24px", "24px", "40px"]}
      >
        <ColorThemeButton />
      </Box>
      <Box position={"absolute"} bottom={"30px"} right={"calc(50% - 20px)"}>
      ...
      <Flex justifyContent={"center"} alignItems={"center"} height={"100%"}>
        <Stack spacing={"20px"} direction={["column", "column", "row"]}>
          ...
          <Box paddingX={"20px"}>
            ...
            <List marginY={"8px"}>
              <ListItem>
                🐶 Web Developer at Aidemy inc. (mainly frontend with
                TypeScript)
              </ListItem>
              <ListItem>⚡️ Sometimes create games and videos</ListItem>
            ...
            >
              <Link href={"https://github.com/kokiito"}>
                <Icon as={FaGithub} size={"20px"} />
              </Link>
              <Link href={"https://twitter.com/koki_robo"}>
                <Icon as={FaTwitter} size={"20px"} />
              </Link>
              <Link href={"https://zenn.dev/kokiito_robot"}>
                <Icon as={ZennIcon} size={"20px"} mb={"8px"} />
              </Link>
              <Link href={"https://www.youtube.com/@kokidevlife6448"}>
                <Icon as={FaYoutube} size={"20px"} />
              </Link>
              <Link href={"https://www.instagram.com/debris_works_/"}>
